<%-- 
    Document   : enterRoll
    Created on : 18-Apr-2019, 16:38:26
    Author     : LENOVO
--%>
...
<html>
    <head>
        ...
        <title>Enter Roll Number | UDIS</title>
    </head>
    <style>
        body{
...
button:hover {
  opacity: 0.95;
    ...
    <body>
        <h1>Enter Student's Roll Number for which Semester Registration is to be done.</h1>
        <form method="post" action="enterRoll" >
